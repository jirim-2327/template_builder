...
#test only
$VmName = "test_VM"
$TemplateVhdx = "D:\Hyper-V\VHDX_Templates\windows_server_2025_datacenter_evaluation_desktop_experience.vhdx"
$DiffDiskPath = "D:\Hyper-V\Virtual_Hard_Disks\test_VM_diff.vhdx"
